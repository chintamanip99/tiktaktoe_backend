...
module Tiktaktoe
  class Application < Rails::Application
    ...
    config.hosts << "192.168.29.2"
    config.hosts << "tiktaktoe-backend.notmaniac.com"
    config.hosts << "tiktaktoe-backend.chintamanipatil.in"
    config.action_cable.allowed_request_origins = ['http://192.168.29.2:3002/','http://192.168.10.100:3001/','http://192.168.1.3:8081/','http://192.168.1.9:8081/','http://192.168.1.5:3002/','http://15.206.26.154:3002/',"http://tiktaktoe.notmaniac.com/","http://192.168.29.101:3002","http://tiktaktoe.chintamanipatil.in"]
